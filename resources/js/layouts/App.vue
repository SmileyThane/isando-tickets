  ...
  <v-app light>
    <v-content>
      <v-parallax height="1000" src="/login_bg.jpg">
        <v-layout align-center class="white--text" column justify-center style="margin-top: 10%;">
                      ...
                      >
                        <v-card-title>
                          ...
                          <span class="title font-weight-light">
                                                        {{ plan_price.plan.name }} ({{ item.symbol }}{{
                              plan_price.price
                            }})</span>
                          <v-spacer></v-spacer>
                          <v-btn :href="'/register?plan_price_id='+plan_price.id" icon>
                            <v-icon>
