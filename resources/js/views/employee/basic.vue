    ...
    <v-row justify="center">
        ...
        <v-dialog v-model="rolesDialog" max-width="600px" persistent>
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="red" text @click="rolesDialog = false">{{
                            langMap.main.cancel
                        }}</v-btn>
                    <v-btn :color="themeBgColor" text @click="updateRole">{{
                            langMap.main.save
                        }}</v-btn>
                </v-card-actions>
            </v-card>
        ...
        <v-dialog v-model="isAccessedDialog" max-width="600px" persistent>
            <v-card>
                ...
                <v-card-text>
                    {{
                        userData.is_active === true
                            ? langMap.individuals.give_access
                            : langMap.individuals.remove_access
                    }}
                    <v-select
              ...
              "
                    ...
                    <v-btn :color="themeBgColor" text @click="changeIsAccessed">{{
                            langMap.main.save
                        }}</v-btn>
                </v-card-actions>
            </v-card>
