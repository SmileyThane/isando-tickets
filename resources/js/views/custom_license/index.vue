    ...
    data() {
        return {
            ...
            headers: [
                ...
                {text: `${this.$store.state.lang.lang_map.custom_license.ixarma}`, value: 'has_ixarma'},
                {text: `${this.$store.state.lang.lang_map.custom_license.ixarma_app}`, value: 'has_ixarma_app'},
                {text: `${this.$store.state.lang.lang_map.custom_license.ticketing}`, value: 'has_ticketing'},
                {text: `${this.$store.state.lang.lang_map.custom_license.time_tracking}`, value: 'has_tracker'},
                {text: `${this.$store.state.lang.lang_map.custom_license.time_tracking}`, value: 'is_active'},
            ],
            customersSearch: '',
            customers: [],
