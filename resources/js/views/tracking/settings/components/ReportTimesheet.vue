    ...
    <div>
        <div class="d-flex flex-grow-1 flex-row">
            ...
            <div class="d-inline-block flex-grow-1" style="width: 33%">
                <client-select :items="$store.getters['Clients/getClients']"></client-select>
            </div>
            <div class="d-inline-block flex-grow-1" style="width: 33%">
                <coworker-select :items="$store.getters['Team/getCoworkers']"></coworker-select>
            </div>
        </div>
        <div class="d-flex flex-grow-1 flex-row">
            <div class="d-inline-block flex-grow-1" style="width: 33%"></div>
            <div class="d-inline-block flex-grow-1 text-center" style="width: 33%">
                <v-btn :color="themeBgColor">Generate report</v-btn>
            </div>
            <div class="d-inline-block flex-grow-1" style="width: 33%"></div>
        </div>
    </div>
