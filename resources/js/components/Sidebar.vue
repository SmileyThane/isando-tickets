                    ...
                    <v-tooltip right :disabled="!localDrawer">
                        <template v-slot:activator="{ on, attrs }">
                            ...
                            >
                                ...
                                <v-list-item-content>
                                    <v-list-item-title>{{ langMap.sidebar.projects_list }}
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                        </template>
            ...
            <v-tooltip right :disabled="!localDrawer">
                <template v-slot:activator="{ on, attrs }">
                    ...
                    >
                        ...
                        <v-list-item-content>
                            <v-list-item-title>{{ langMap.sidebar.links }}</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </template>
                <span>{{ langMap.sidebar.links }}</span>
            </v-tooltip>
            <v-divider></v-divider>
...
export default {
    ...
    mounted() {
        ...
        this.links = this.langMap.sidebar.links;
